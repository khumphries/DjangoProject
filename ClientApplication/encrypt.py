...
def secret_string(secret, key):
    """ Performs RSA Public Key Encryption on inputted file using the given public key """
    return key.encrypt(secret.encode(encoding='UTF-8'), 24)[0]
